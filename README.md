...
# Generalized Deep Learning-Based Segmentation with Multi-Algorithm Bidirectional Path Extension Tracking for Hybrid Machine Learning Prediction of iPS Progenitor Cell Dynamics #

The code in this repository is supplementary to our future publication **Generalized Deep Learning-Based Segmentation with Multi-Algorithm Bidirectional Path Extension Tracking for Hybrid Machine Learning Prediction of iPS Progenitor Cell Dynamics** 
...
Clone the iPS-prediction repository:
```
https://github.com/jovialniyo93/iPS-prediction.git
```
Open the Anaconda Prompt (Windows) or the Terminal (Linux), go to the iPS-prediction repository and create a new virtual environment:
```
...
```
Activate the virtual environment iPS-prediction_ve:
```
conda activate iPS-prediction_ve
```
## Dataset
...
## 2. Model Testing with individual tracking and feature extraction
...
## 5. Hybrid model for iPS Progenitor Cell Prediction

**To run the scripts, You can use Jupyter notebook or Google Colaboratory:**
